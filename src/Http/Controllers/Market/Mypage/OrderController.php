...
class OrderController extends Controller
{
  ...
  public function index(Request $request)
  {
    ...
    return view('market.templates.userpage.'.config('market.template.userpage.theme').'.order.orders', [
      'user' => $user,
      'items' => $items,
    ]);
  ...
  public function view($o_id, Request $request) {
    ...
    return view('market.templates.userpage.'.config('market.template.userpage.theme').'.order.view', [
      'user' => $user,
      'items' => $items,
      'display' =>$display,
    ]);
