...
use App\Models\Market\Auth\User\Traits\Relations\SocialAccountRelations;
...
class SocialAccount extends Model
{
     ...
     * @var array
     */
    protected $fillable = ['user_id', 'name', 'email', 'provider', 'provider_id', 'token', 'refresh_token', 'avatar'];
}
