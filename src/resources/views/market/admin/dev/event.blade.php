...
<div class="p-3 mb-4 bg-light rounded-3">
  ...
  <div class="card">
    <div class="card-body">
      <div>이벤트의 작동유무를 확인하실 수 있습니다.</div>
    </div><!-- .card-body -->
  </div><!-- .card -->
</div>
...
<form method="POST" name="mail-form" action="{{ route('market.admin.dev.event') }}">
@csrf
    <div class="card-body">
...
$(function(){
  $(".act-mail-preview").on('click', function(){
    MARKET.routetostring({'name': 'market.admin.dev.mail.preview', 'params[0]': $("form[name='mail-form']").serialize(), },
    function(resp) {
      console.log(resp);
      if(resp.error) {
