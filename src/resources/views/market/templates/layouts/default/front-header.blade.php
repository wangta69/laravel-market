...
<div class="container d-flex justify-content-between font-size-12" id="header-top">
  ...
  @guest
  <menu>
    <li><a href="{{ route('market.login') }}" class="nav-link" href="{{ route('market.login') }}">로그인</a></li>
    <li><a href="{{ route('market.register') }}" class="nav-link">회원가입</a></li>
    <!-- <li>고객센터</li> -->
  </menu>
  @else
  <menu>
    <li> <a class="nav-link" href="{{ route('market.mypage.user') }}"><b>{{Auth::user()->name}}</b>님</a></li>
    <li><a class="nav-link" href="{{ route('market.logout') }}">로그아웃</a></li>
    <!-- <li>고객센터</li> -->
