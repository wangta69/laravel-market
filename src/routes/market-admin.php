...
/*
    ...
    <li><a href="./main.php?menushow=menu1&theme=basicconfig/basic_info4">몰스킨 설정</a></li>
  ...
  <ul class="leftmenulist">
    <li><a href="./main.php?menushow=menu2&theme=product/product1">상품신규등록</a></li>
  ...
  <ul class="leftmenulist">
    <li><a href="./main.php?menushow=menu3&theme=catmanager/shopmanager1">카테고리설정</a></li>
    <li><a href="./main.php?menushow=menu3&theme=catmanager/shopmanager2">카테고리순서설정</a></li>
  </ul>
